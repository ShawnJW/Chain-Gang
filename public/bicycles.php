...
<div id="main">
  ...
  <div id="page">
    ...
    <table id="inventory">
      ...
      // $args = ['brand' => 'Trek', 'model' => 'Emonda', 'year' => 2017, 'gender' => 'Unisex', 'color' => 'black', 'weight_kg' => 1.5, 'price' => 100, 'category' => 'road', 'condition_id' => '1'];
      ...
      <tr>
        ...
        <td><a href="details.php?id=<?php echo $bike->id; ?>">View</a></td>
      </tr>
    <?php } ?>
    </table>
